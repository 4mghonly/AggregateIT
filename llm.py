...
AUTH_HEADER=_env("LLM_AUTH_HEADER") or "Authorization"
AUTH_SCHEME=_env("LLM_AUTH_SCHEME") or "Bearer"
CHAT_PATH="/"+(_env("LLM_CHAT_PATH") or "chat/completions").lstrip("/")
FALLBACK_AUTH_HEADER=_env("LLM_FALLBACK_AUTH_HEADER") or "Authorization"
FALLBACK_AUTH_SCHEME=_env("LLM_FALLBACK_AUTH_SCHEME") or "Bearer"
FALLBACK_CHAT_PATH="/"+(_env("LLM_FALLBACK_CHAT_PATH") or "chat/completions").lstrip("/")
try:
